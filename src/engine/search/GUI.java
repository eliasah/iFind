...
public class GUI implements Runnable{
	...
	// la GUI se d�finit comme telle :
    // une interface de base contenant une menubar habituelle avec fichier, edition et aide... de plus on a un champ de recherche de type textfield et un bouton (rechercher), ainsi qu'un bouton advanced  qui permet d afficher l interface de l utilisateur avanc�. Il y a egalement une JTable qui fait office de tableau des r�sultats de la recherche.
